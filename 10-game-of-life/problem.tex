...
\begin{document}
	...
	\begin{tabular}{ |l|l| } 
		...
		{\lstinputlisting{./testCases/input/input04.txt}} & {\lstinputlisting{./testCases/output/output04.txt}} \\ % use {\lstinputlisting{./testCases/input/input00.txt}} & {\lstinputlisting{./testCases/output/output00.txt}}
		\hline
	\end{tabular}
