...
\begin{document}
	...
	\begin{itemize}
		...
		\item The next $n$ lines contain $n$ space-separated values each, either $0$ or $1$.
	\end{itemize}
	...
	\begin{tabular}{ |l|l| } 
		...
		{\lstinputlisting{./testCases/input/input14.txt}} & {\lstinputlisting{./testCases/output/output14.txt}} \\ % use {\lstinputlisting{./testCases/input/input00.txt}} & {\lstinputlisting{./testCases/output/output00.txt}}
		\hline
	\end{tabular}
